 ...
 * Mac OS X Internals, Chapter 12, Section 7.1.2, Figure 12-11
 * Pages 1507-1508
 * Compilation instructions page 1509
 * Compile with:
...
main(int argc, char **argv)
{
    ...
    ret = fsctl(argv[1], HFS_CHANGE_NEXT_ALLOCATION, (void *)block_number,
				(unsigned long)0);
    if (ret) {
        perror("fsctl");
    } else {
